          ...
          <ul className="accordion ms-main-aside fs-14" id="side-nav-accordion">
            ...
            <li className="menu-item">
              <Link to="#" className="has-chevron">
                {" "}
                <span>
                  <i className="fa fa-utensils fs-16" />
                  Menus{" "}
                </span>
              </Link>
              <ul
              ...
              >
                <li>
                  {" "}
                  <Link to="/menu-catalogue">Menu Catalogue</Link>
                </li>
                <li>
                  {" "}
            ...
            <li className="menu-item">
              <Link to="#" className="has-chevron">
                {" "}
                <span>
                  <i className="material-icons fs-16">code</i>Advanced UI
                  Elements
                </span>
              </Link>
              <ul
            ...
            <li className="menu-item">
              ...
              >
                {" "}
                <span>
                  <i className="material-icons fs-16">insert_drive_file</i>{" "}
                  Bonus Pages
                </span>
              </Link>
              <ul
              ...
              >
                <li className="menu-item">
                  ...
                  >
                    ...
                    <li>
                      {" "}
                      <Link to="/register">Default Registration</Link>
                    </li>
                    <li>
                      {" "}
