...
const phonetip = <Tooltip>Call</Tooltip>;
const videotip = <Tooltip>Video Call</Tooltip>;
const invitetip = <Tooltip>Add to Chat</Tooltip>;
                    ...
                    <tbody>
                      <tr>
                        <td className="ms-table-f-w">
                          {" "}
                          <img
                            src="assets/img/costic/pizza.jpg"
                            alt="people"
                          />{" "}
                          Pizza{" "}
                        </td>
                      ...
                      <tr>
                        <td className="ms-table-f-w">
                          {" "}
                          <img
                            src="assets/img/costic/cereals.jpg"
                            alt="people"
                          />{" "}
                      ...
                      <tr>
                        <td className="ms-table-f-w">
                          {" "}
                          <img
                            src="assets/img/costic/egg-sandwich.jpg"
                            alt="people"
                          />{" "}
                          Fried Egg Sandwich{" "}
                        </td>
            ...
            <div className="ms-panel ms-widget ms-crypto-widget">
              ...
              <div className="ms-panel-body p-0">
                <Tab.Container defaultActiveKey="mon">
                  <Nav
                    variant="tabs"
                    className="nav nav-tabs nav-justified has-gap px-4 pt-4"
                  >
                    <Nav.Item>
                ...
                <ul className="ms-list ms-feed ms-twitter-feed ms-recent-support-tickets">
                  <li className="ms-list-item">
                    <Link to="#" className="media clearfix">
                      <img
                        src="assets/img/costic/customer-4.jpg"
                        className="ms-img-round ms-img-small"
                        alt="This is another feature"
                      />
                      <div className="media-body">
                        <div className="d-flex justify-content-between">
                          <h6 className="ms-feed-user mb-0">
                            Lorem ipsum dolor
                          </h6>
                        ...
                        <span className="my-2 d-block">
                          {" "}
                          <i className="material-icons">date_range</i> February
                          24, 2022
                        </span>
                        <p className="d-block">
                          Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit. Nulla luctus lectus a facilisis bibendum. Duis
                          quis convallis sapien ...
                        </p>
                  ...
                  <li className="ms-list-item">
                    <Link to="#" className="media clearfix">
                      <img
                        src="assets/img/costic/customer-7.jpg"
                        className="ms-img-round ms-img-small"
                        alt="This is another feature"
                      />
                      <div className="media-body">
