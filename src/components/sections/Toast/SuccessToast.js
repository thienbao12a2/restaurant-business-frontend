...
class SuccessToast extends React.Component {
  ...
  //         break;
  //     }
  //     jQuery("#toast-options").text(
  //       "toastr.options = " + JSON.stringify(toastr.options)
  //     );
          ...
          <div className="col-md-12">
            ...
            <div className="ms-panel">
              ...
              <div className="ms-panel-body">
                <p className="ms-directions">
                  Check <code>/assets/js/toast.js</code> for reference
                </p>
                <div className="row">
            ...
            <div className="ms-panel">
              ...
              <div className="ms-panel-body">
                <p className="ms-directions">
                  Mix and match whatever toast you would like to see
                </p>
                      ...
                      <ul className="ms-list mt-3 ms-list-display">
                        ...
                        <li>
                          <label className="ms-checkbox-wrap">
                            <input
                              type="radio"
                              defaultValue="toast-bottom-center"
                              name="toastPosition"
                            />{" "}
                            <i className="ms-checkbox-check" />
                          </label>{" "}
